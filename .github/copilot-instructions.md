# Spacemacs Maintainer Framework
...
| :--- | :--- | :--- |
| **Marjin** | `@marjin` | Refactorer (Default) |
| **Spacky** | `@spacky` | Coder (Master Elisp Artisan) |
| **Bzzrts** | `@bzzrts` | UI Implementor |
| **Vala Grudge-Keeper** | `@vala-grudge-keeper` | CI Implementor |
| **Dok** | `@dok` | Debugger |
| **G.O.L.E.M.** | `@golem` | Doc & Style Reviewer |
| **Skeek** | `@skeek` | Bug & Security Reviewer |
| **Don Testote** | `@don-testote` | Test Engineer |
| **Nexus-7** | `@nexus-7` | Dependency Manager (Logistics Droid) |
